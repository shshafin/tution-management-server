...
router.post(
  '/create-user',
  auth('super_admin'),
  upload.single('file'), // <--- Must allow file upload here
  // Note: Validation might fail if data comes as FormData.
  // You might need to parse `req.body.data` manually in controller if using FormData
