...
const getAllUsersFromDB = async (query: Record<string, unknown>) => {
  ...
  // 🟢 লজিক: ফাঁকা স্ট্রিং বা undefined কুয়েরি থেকে রিমুভ করা
  // নাহলে QueryBuilder ফাঁকা নাম "" ওয়ালা ইউজার খুঁজবে এবং ডাটা পাবে না
  const queryObj = { ...query };
  const excludeFields = ['searchTerm', 'sort', 'limit', 'page', 'fields'];
  excludeFields.forEach((el) => delete queryObj[el]);

  // ফাঁকা ভ্যালু রিমুভ করা
  ...
  const userQuery = new QueryBuilder(User.find(), query)
    ...
    .filter() // 🟢 এখন ফিল্টার ক্লিন ডাটা পাবে
    .sort()
    .paginate()
    .fields();
...
const getSingleUserFromDB = async (id: string) => {
  // 🟢 পপুলেট করার প্রয়োজন হলে এখানে .populate('something') দিতে পারিস
