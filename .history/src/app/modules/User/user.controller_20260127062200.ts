...
const createTutor = catchAsync(async (req: Request, res: Response) => {
  ...
  // 🟢 ডিফল্ট ইমেজ লজিক: ইমেজ না থাকলে uploads ফোল্ডারের ইমেজ পাথ সেট হবে
  req.body.image = imageUrl ? imageUrl : '/uploads/default-image.jpg';
...
const updateUser = catchAsync(async (req: Request, res: Response) => {
  ...
  // 🟢 আপডেটের সময় যদি নতুন ইমেজ না দেওয়া হয়, তবে আগের ইমেজটাই থাকবে
