...
const verifyPaymentManuallyByAdminFromDB = async (paymentId: string) => {
  ...
  try {
    // ১. পেমেন্ট রেকর্ড খুঁজে বের করা এবং প্যাকেজ ডাটা পপুলেট করা
    ...
    // ২. চেক করা পেমেন্ট কি অলরেডি কমপ্লিটেড?
    if (paymentRecord.status === 'completed') {
      throw new AppError(
        httpStatus.BAD_REQUEST,
    ...
    // ৩. ইউজারের ক্রেডিট বাড়িয়ে দেওয়া
    ...
    // ৪. পেমেন্ট স্ট্যাটাস আপডেট করা
    paymentRecord.status = 'completed';
    paymentRecord.paymentMethod = 'manual_admin'; // ম্যানুয়াল পেমেন্ট বুঝার জন্য
