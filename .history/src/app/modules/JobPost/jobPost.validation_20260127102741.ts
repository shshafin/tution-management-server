...
const createJobPostValidationSchema = z
  .object({
    ...
    minSalary: z
      .number({ required_error: 'মিনিমাম স্যালারি আবশ্যক' })
      .positive(),
    maxSalary: z
      .number({ required_error: 'ম্যাক্সিমাম স্যালারি আবশ্যক' })
      .positive(),
    ...
    daysPerWeek: z
      .number({ required_error: 'সপ্তাহে কতদিন তা আবশ্যক' })
      .min(1)
      .max(7),
    // 🟢 transform এখানে ডেট অবজেক্ট বানাবে, যা ডাটাবেজ মডেলে সরাসরি সেভ হবে
    demoClassDate: z
      .string({ required_error: 'ডেমো ক্লাসের তারিখ আবশ্যক' })
