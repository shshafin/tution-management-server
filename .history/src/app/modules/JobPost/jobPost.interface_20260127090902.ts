...
// ৩. সাবজেক্ট ব্যাকগ্রাউন্ড (Tutor Requirement)
export type TSubjectBackground = 'CSE' | 'English' | 'Math' | 'Physics' | 'Chemistry' | 'Biology' | 'Arts' | 'Commerce';

// ৪. প্রেফারড টাইম
export type TPreferredTime = 'morning' | 'afternoon' | 'evening' | 'tutor_availability';
